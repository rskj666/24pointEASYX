...
IMAGE image_resultnowtrue;
IMAGE image_resultnowfalse;
IMAGE image_resultnowempty;
//图形对象实例
...
IMAGINATION result_image(1220, 630,150 , 150, image_resultnowempty); // 结果图片
LABEL result_label(1020, 625, 350, 150, "1\n2"); // 结果标签

// 运行函数
// 初始化函数
POKE init(int num1, int num2, int num3, int num4) {
    loadimage(&image_firstcode, _T("CODE_FIRST.png"));
    loadimage(&image_resultnowtrue, _T("CODE_RESULTTRUE.png"));
    loadimage(&image_resultnowfalse, _T("CODE_RESULTFALSE.png"));
    loadimage(&image_resultnowempty, _T("CODE_RESULTEMPTY.png"));
